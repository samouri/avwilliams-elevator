...
var SPEED_UP = 1.0/3; //3x speed up
...
var FLOOR1Y = 341
var FLOORS_Y = [FLOOR1Y, FLOOR1Y-FLOOR_DISTANCE, FLOOR1Y-FLOOR_DISTANCE*2, FLOOR1Y-FLOOR_DISTANCE*3];

var panel1 = new Image();
var panel2 = new Image();
var elevator_shafts = new Image();
var request_panel = new Image();
var elevator1_img = new Image();
var elevator2_img = new Image();
var elevator1_ding = new Audio();
var elevator2_ding = new Audio();
...
var panel2_buttons = {
  btn1: merge(circle_btn,{x: 644, y:84, floor:1}),
  btn2: merge(circle_btn,{x: 737, y:84, floor:2}),
  btn3: merge(circle_btn,{x: 644, y:23, floor:3}),
  btn4: merge(circle_btn,{x: 737, y:23, floor:4}),
  open: merge(circle_btn,{x: 644, y:206}),
  close: merge(circle_btn,{x: 737, y:206})
}
...
var all_buttons = mergeToArr(request_buttons, mergeToArr(panel1_buttons, panel2_buttons));

function init(){
  panel1.src = 'panel1.png';
  panel2.src = 'panel2.png';
  elevator_shafts.src = 'elevator-shafts.png';
  request_panel.src = 'request-panel.png';
  elevator1_img.src = 'elevator.png';
  elevator2_img.src = 'elevator.png';
  elevator1_ding.src = 'ding.mp3';
  elevator2_ding.src = 'ding.mp3';

  elevator1_img.onload = function() {
    elev1 = createElevator();
    elev2 = createElevator();
    elev2.x += 167; //offset the second elevator
    elev1.ding = elevator1_ding;
    elev2.ding = elevator2_ding;
  }
...
function draw(t_frame) {
  ...
  ctx.drawImage(panel2, CANVAS_WIDTH-panel2.naturalWidth, 0.0);
  ...
  ctx.drawImage(elevator2_img, elev2.x, elev2.y);
  drawElevDoors(ctx, elev1, 'rgb(128,128,128)');
  drawElevDoors(ctx, elev2, 'rgb(128,128,128)');
  ...
  elevator_step(elev2, time_dx, panel2_buttons, request_buttons);
  t_last = t_frame;
}
